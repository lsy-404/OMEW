...
- 2026-09-12：提交 `cce0ee1` 快进合并到 OMEW `main` 并推送，部署 `stardust-omew` 版本 `70db03be-8b2c-415a-9856-48b6de9acaea`。
- 2026-09-12：Edge 已登录真实入口自动完成 OIDC 并进入 `medium5`；可见用户名为 `mxjw`/`@mxjw`，用户菜单仅有个人设置，无登出入口，任务闭环通过。
